...
class MQTTBrokerDevices:
  ...
  def __init__(self,client_id,server,port,username,password,topic_publish,topic_subscribe):  
    ...
    print("[Hardware-Devices] : Configuration of MQTT broker part completed",end="\n\n")
  ...
  def publish(self,message):
    print("[Hardware-Devices] : Publishing of message  : \n===>" + message)
    self.client.publish(self.topic_publish,message)
    print("[Hardware-Devices] : Publishing of message completed",end="\n\n")
